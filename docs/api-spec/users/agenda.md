...
> Endpoint agenda yang memerlukan autentikasi: pendaftaran, checkout, dan manajemen agenda user.
>
> **Endpoint publik** (daftar agenda, detail agenda) ada di [public/agenda.md](../public/agenda.md).

**Base URL:** `/api/v1`

---

## 1. Daftar Agenda (Gratis)
